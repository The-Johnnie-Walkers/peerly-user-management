...
import type { CreateInterestUseCase } from "src/modules/user/domain/ports/in/create-interest-use-case.port";
import type { DeleteInterestUseCase } from "src/modules/user/domain/ports/in/delete-interest-use-case.port";
import type { GetAllInterestsUseCase } from "src/modules/user/domain/ports/in/get-all-interests-use-case.port";
import type { GetInterestUseCase } from "src/modules/user/domain/ports/in/get-interest-use.case.port";
import type { UpdateInterestUseCase } from "src/modules/user/domain/ports/in/update-interest-use-case.port";
