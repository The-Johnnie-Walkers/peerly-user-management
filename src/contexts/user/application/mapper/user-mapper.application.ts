...
import { UserRequestDTO } from "../../infrastructure/adapters/in/http/dto/request/user-request.dto";
import { User } from "../../domain/entities/user.entity";
import { Status } from "../../domain/enums/status.enum";
import { UserResponseDTO } from "../../infrastructure/adapters/in/http/dto/response/user-response.dto";
import { InterestRequestDTO } from "../../infrastructure/adapters/in/http/dto/request/interest-request.dto";
import { Interest } from "../../domain/entities/interest.entity";
import { InterestResponseDTO } from "../../infrastructure/adapters/in/http/dto/response/interest-response.dto";
import { FreeTimeScheduleRequestDTO } from "../../infrastructure/adapters/in/http/dto/request/free-time-schedule-request.dto";
import { FreeTimeSchedule } from "../../domain/entities/free-time-schedule.entity";
import { FreeTimeScheduleResponseDTO } from "../../infrastructure/adapters/in/http/dto/response/free-time-schedule-response.dto";
